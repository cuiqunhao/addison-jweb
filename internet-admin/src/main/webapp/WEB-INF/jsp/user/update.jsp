			...
			<div class="row">
				...
				<sf:form method="post" modelAttribute="userDto" id="addForm" cssClass="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<sf:input path="username" size="30" cssClass="col-xs-10 col-sm-5"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<sf:checkboxes  items="${roles}" itemLabel="name" itemValue="id" path="roleIds" cssStyle="padding-top:10px;padding-left:15px;"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<sf:checkboxes items="${groups}" path="groupIds" itemLabel="name" itemValue="id" cssStyle="padding-top:10px;padding-left:15px;"/>
						</div>
					</div>
