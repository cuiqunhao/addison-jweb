package com.internet.cms.controller.spider;
...
public class SpiderController {
	...
	public String list(Model model, String type) {
		model.addAttribute("datas",
				cmsLinkService.findByType(UrlUtil.encodeParam(type)));
	...
	public String update(@PathVariable int id, @Validated CmsLink cmsLink,
			BindingResult br) {
		if (br.hasFieldErrors()) {
			return "cmsLink/update";
		}
